const projectsData = [
  {
    ...
    description: "Designed and optimized API layers for real-time banking operations with strong security and compliance controls.",
  ...
  },
  {
    ...
    description: "Implemented a monitoring dashboard that visualizes usage metrics and performance for distributed services.",
  ...
  },
  {
    ...
    description: "Built a data pipeline and dashboard to surface predictive insights from large-scale transaction datasets.",
    ...
    tags: ["Python", "Machine Learning", "Kafka"]
  }
];
